...
func start_dialogue():
	...
	DialogueManager.show_dialogue([
		...
		"Heard that you managed to deliver to my friend back on the other island, i am truly impressed!",
		"Good luck ahead, Safe travels, captain!"
	], _on_dialogue_finished)

func _on_dialogue_finished():
	Transition.change_scene("res://level_root3.tscn")  # swap in your actual scene path
